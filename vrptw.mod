...
#s.t. ServeAllOnlyOnce1{n in Nodes, t in Trains} :
#    sum{w in Warehouses: w!=n} takeRoute[t, n, w] == 1; 
...
s.t. ServeAllOnlyOnce1{n in Nodes, t in Trains} :
    sum{w in Warehouses: w!=n} takeRoute[t, w, n] == 1; 

s.t. EnsureFlow{n in Nodes, t in Trains}: 
    sum{nn in Nodes:n!=nn} takeRoute[t, n,nn] - sum{nn in Warehouses:nn !=n} takeRoute[t, nn, n] == 0;
